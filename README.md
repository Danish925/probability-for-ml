...
data, and statistical reasoning are handled in ML — not to focus on exam-style
...
│
├── notebooks/
│ ├── Part1_Probability_Basics.ipynb
│ ├── Part2_Random_Variables.ipynb
│ ├── Part3_Probability_Distributions.ipynb
│ ├── Part4_Statistics_Basics.ipynb
│ ├── Part5_Sampling_and_Estimation.ipynb
│ └── Part6_Hypothesis_Testing.ipynb
│
├── README.md
├── .gitignore
└── LICENSE
